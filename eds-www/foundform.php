...
<html>
  ...
  <body>
    ...
    <p class="description"> If you have found an item, please fill out the form below. </p>
    ...
    <?php
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST')
      {
        ...
        if(!empty($_FILES["fileToUpload"]["name"])){
            ...
            VALUES ("' . $itemname . '" , "' . $location . '" , "' . $descr . '" , "' . $fname . '" , "' . $lname . '" , "' . $email . '" , "' . $phonenum . '" , "found" , "' . $date . '" , "' . $target_file . '")';
            //show_query($query);
            $result = mysqli_query($dbc,$query) ;
             header('Location: foundupdate.php'); 
            }
            else{
                ...
                VALUES ("' . $itemname . '" , "' . $location . '" , "' . $descr . '" , "' . $fname . '" , "' . $lname . '" , "' . $email . '" , "' . $phonenum . '" , "found" , "' . $date . '")';
            //show_query($query);
            $result = mysqli_query($dbc,$query) ;
    ...
    <form action="foundform.php" id='foundsubmit' method='POST' enctype="multipart/form-data">
      ...
      <p class="description">Location Found*:
